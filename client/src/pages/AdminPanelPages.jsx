...
function AdminPanel() {
  ...
  const loadData = async () => {
    try {
      const [articlesRes, categoriesRes, commentsRes] = await Promise.all([
        axios.get(`${import.meta.env.VITE_BACKEND_DOMAIN}/articles`, { headers }),
        axios.get(`${import.meta.env.VITE_BACKEND_DOMAIN}/categories`, { headers }),
        axios.get(`${import.meta.env.VITE_BACKEND_DOMAIN}/comments`, { headers }),
      ]);
      ...
      if (user?.role === 'admin') {
        const usersRes = await axios.get(`${import.meta.env.VITE_BACKEND_DOMAIN}/users/all`, { headers });
  ...
  const handleDeleteUser = async (userId) => {
    ...
    try {
      await axios.delete(`${import.meta.env.VITE_BACKEND_DOMAIN}/users/${userId}`, { headers });
  ...
  const handleApprove = async (commentId) => {
    try {
      await axios.put(`${import.meta.env.VITE_BACKEND_DOMAIN}/comments/${commentId}/approve`, {}, { headers });
      loadData();
    } catch (err) {
  ...
  const handleArticleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post(`${import.meta.env.VITE_BACKEND_DOMAIN}/articles`, newArticle, { headers });
      setNewArticle({
  ...
  const handleCategorySubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post(`${import.meta.env.VITE_BACKEND_DOMAIN}/categories`, newCategory, { headers });

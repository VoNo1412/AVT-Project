...
function HomePage() {
  ...
  useEffect(() => {
    setLoading(true);
    axios.get(`${import.meta.env.BACKEND_DOMAIN}/api/articles?search=${searchQuery}`)
  ...
  useEffect(() => {
    ...
    debounceRef.current = setTimeout(() => {
      ...
      const url = query === ''
        ? `${import.meta.env.BACKEND_DOMAIN}/api/articles`
        : `${import.meta.env.BACKEND_DOMAIN}/api/articles?search=${encodeURIComponent(query)}`;
